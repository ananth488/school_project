...
const Home = () => {
  useEffect(() => {
    ...
    sr.reveal(".head", { delay: 100, origin: "bottom" });
    sr.reveal(".heading", { delay: 100, origin: "bottom" });
    sr.reveal(".headings", { delay: 100, origin: "bottom" });
  }, []);
    ...
    <>
      ...
      <div className="heading">
        <div className={styles.our_causes_main}>
          <h2 className="head">Our Major Causes</h2>
          <p>
            The French Revolution constituted for the conscience of the dominant
            aristocratic class a fall from innocence the natural chain of
            events.
          </p>
        ...
        <div className={styles.aboutus_main}>
          <div className={styles.aboutus_main_first}>
            ...
            <p>
              ...
              (‘thaagam’) is to serve humanity. We believe humanity consists of
              people, animals, and the environment. We uphold our commitments to
              all living things by implementing innovative and effective
              programmes for the underprivileged, animal welfare, and the
              environment.
            </p>
            <button>
